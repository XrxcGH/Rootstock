...
final class TelemetryDescriptorTest {
  ...
  final class Overloads {
    ...
    void everyMethodReturnsTheDescriptorForChaining() {
      ...
      assertEquals("Rootstock/Elevator/FeedbackVolts", schema.extraKey("FeedbackVolts"));
      assertEquals("Rootstock/Elevator/DeviceResetCount", schema.extraKey("DeviceResetCount"));
    }
  }
  ...
  final class NoUnitMetadata {
    ...
    void declaringTheSameUnitFreeKeyTwiceIsHarmless() {
      ...
      assertEquals("Rootstock/Elevator/Plan", schema.extraKey("Plan"));
    }
  ...
  final class Declaration {
    ...
    void extrasKeepDeclarationOrderAndNotHashOrder() {
      ...
      int zulu = keys.indexOf("Rootstock/Elevator/Zulu");
      int alpha = keys.indexOf("Rootstock/Elevator/Alpha");
      int mike = keys.indexOf("Rootstock/Elevator/Mike");
