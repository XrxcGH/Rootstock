 ...
 *       org.rootstock.hardware.phoenix.TalonFXMotorIO}, with a real {@code applyRaw(Consumer)} — but
 *       it ships in the separate {@code rootstock-phoenix6} artifact, which this test source set
 ...
 * Mechanism} builds a {@code RootstockAlert}, which eagerly constructs an {@code
...
public final class RobotContainer {
  ...
  public RobotContainer() {
    ...
    RootstockRegistry.addAll(kElevator, kArm, kRoller, m_super);
    ...
    // the rootstock-phoenix6 artifact which this source set may not depend on:
    //
