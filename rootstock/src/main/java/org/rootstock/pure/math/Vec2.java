 ...
 *
 * <p>This type exists for one reason: ArchUnit rule 8 forbids {@code org.rootstock.pure} from
 * importing anything under {@code edu.wpi.first}, and it is verified by a bytecode scan rather than
 * by convention. {@code design/05} §2 wrote {@link RootstockMath#deadband2d} as returning a WPILib
 ...
 * it costs a caller in {@code org.rootstock.drive} exactly one line:
 *
 * <pre>{@code
 * Vec2 v = RootstockMath.deadband2d(x, y, 0.10);
...
public record Vec2(double x, double y) {
  ...
  /** The origin. Returned by {@link RootstockMath#deadband2d} when the input is inside the band. */
