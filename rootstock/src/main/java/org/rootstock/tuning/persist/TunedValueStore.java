 ...
 *   <li>{@link ValueSource#DEPLOY_FILE} — {@code src/main/deploy/rootstock/gains.json}, checked into
 *       git. This is the team's committed, reviewed answer.
 *   <li>{@link ValueSource#ROBOT_FILE} — {@code Platform.persistentDir()/rootstock/gains.json}, written
...
public final class TunedValueStore {
  ...
  public static final String kSchema = "rootstock.gains/1";
  ...
  /**
   * The runtime file: {@code Platform.persistentDir()/rootstock/gains.json} on the roboRIO, and
   * {@code ./rootstock/gains.json} in desktop simulation.
   *
  ...
  /**
   * The committed file: {@code Platform.deployDir()/rootstock/gains.json}, which is
   * {@code src/main/deploy/rootstock/gains.json} in desktop simulation.
   *
  ...
  public static void stamp(Map<String, Object> file) {
    ...
    file.put("writtenBy", "Rootstock " + org.rootstock.core.Rootstock.VERSION);
