 ...
 * {@link org.rootstock.control.TuningSupervisor#isArmed()}. Publishing the state as a first-class
...
public enum WizardState {
   ...
   * hard throw in {@link org.rootstock.control.TuningSupervisor#arm()} is a usable safety feature
   * rather than a crash: eleven precise sentences reach the student instead of a stack trace.
   */
  READY(false),

  /**
   * {@link org.rootstock.control.MechanicalHealthCheck} is running, once per session, before the
  ...
  /**
   * {@code RootstockLog.isReplay()} is true. A replay re-runs recorded inputs; commanding a motor
