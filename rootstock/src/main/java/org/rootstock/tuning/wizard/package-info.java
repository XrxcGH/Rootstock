/**
 * The guided tuning wizard — the part of Rootstock that exists to <em>teach</em>.
 *
 * <p>Everything else in {@code org.rootstock.tuning} produces numbers. This package produces
 * students. It is a state machine ({@link org.rootstock.tuning.wizard.TuningWizard}) over an
 * ordered list of small strategy objects ({@link org.rootstock.tuning.wizard.TuningStep}) that is
 * itself just data ({@link org.rootstock.tuning.wizard.TuningRecipe}). Nothing here is
 ...
 *       org.rootstock.tuning.wizard.Lessons#WHY_FEEDFORWARD_FIRST}.
 *   <li><b>Every volt goes through {@link org.rootstock.control.TuningSupervisor}.</b> No class in
 ...
 *       org.rootstock.tuning.wizard.steps.PredictStep} is not decoration. Without it a student can
 ...
 * {@link org.rootstock.tuning.wizard.Recipes#supported()}.
 */
