/**
 * The tuning UI surface: every {@code /RootstockTuner/} NetworkTables topic, and the generated Elastic
 ...
 * NT4.
 *
 * <p>Nothing editable lives under {@code /RootstockTuner/}: editable values are at
