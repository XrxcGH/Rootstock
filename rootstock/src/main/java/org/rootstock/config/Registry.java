 ...
 *
 * <p><b>Why an opt-out and not an opt-in.</b> {@code RootstockRegistry.addAll(m_drive, m_elevator,
...
public enum Registry {
  ...
  /**
   * Logging under {@code /Rootstock/&lt;Mechanism&gt;/}.
   *
   ...
   */
  TELEMETRY(RootstockRegistry.kRouteTelemetry, "logging under /Rootstock/<name>/"),
   ...
   */
  HEALTH(RootstockRegistry.kRouteHealth, "the round-robin health sweep"),
   ...
   */
  SELFTEST(RootstockRegistry.kRouteSelfTest, "the one-button pit self test"),
   ...
   */
  TUNING(RootstockRegistry.kRouteTuning, "live gain and constraint tuning");
  ...
  /**
   * The routing label {@code RootstockRegistry} uses for this facet.
   *
   * <p>Tied to the {@code RootstockRegistry.kRoute*} constants at compile time so the enum and the
