 ...
 *
 * <p>A switch on a roboRIO DIO channel cannot stop the motor in firmware. Rootstock zeroes the
...
public sealed interface SensorSpec
   ...
   *
   * <p>Cannot stop a motor in firmware. Rootstock zeroes the output in the same loop it sees the
