 ...
 * interlock and its {@code explanation}; and {@code /Rootstock/Superstructure/Blocked} carries the
...
public record Interlock<S extends Enum<S>>(
  ...
  /**
   * The sentence the alert and {@code /Rootstock/Superstructure/Blocked} carry.
   *
   * @param from the source state
   * @param to the destination state
