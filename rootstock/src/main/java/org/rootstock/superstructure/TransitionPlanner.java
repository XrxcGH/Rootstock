 ...
 *
 * <p>So Rootstock has <b>no</b> time-based waypoint gate. A waypoint may carry a timeout, and a
...
public final class TransitionPlanner<S extends Enum<S> & SuperState> {
  ...
  public static final class Plan<S extends Enum<S> & SuperState> {
     ...
     * {@code /Rootstock/Superstructure/Blocked}.
     *
    ...
    /**
     * The waypoint names, as {@code /Rootstock/Superstructure/Plan} publishes them.
     *
