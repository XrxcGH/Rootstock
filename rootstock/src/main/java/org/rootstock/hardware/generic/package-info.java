 ...
 *
 * <p>{@link org.rootstock.hardware.generic.GenericMotorIO} forces {@code
 * ControlLocation.RIO_FULL} and runs its profile, feedback and feedforward through the shared {@link
 * org.rootstock.hardware.RioControlLoop} — the same object every other backend uses when it is
 ...
 * what was lost.
 *
 * <p>{@link org.rootstock.hardware.generic.DioSensorIO} owns the two things a subsystem otherwise
