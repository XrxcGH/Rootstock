 ...
 * library's principles: Rootstock models what is worth modelling and hands you the real device for
 * everything else.
 *
 * <pre>{@code
...
public interface MotorIO {
   ...
   *
   * <p>Documented here, on page one, rather than in an appendix. Rootstock does not model every
