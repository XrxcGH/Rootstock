 ...
 * cannot reason from.
 *
 * <p>Written <b>before</b> {@code RootstockLog.start()}; the facade closes metadata after that, so a
...
public final class ProvenanceSchema {
  ...
  /** The Rootstock version. */
  public static final String kRootstockVersion = "RootstockVersion";
   ...
   * {@code RootstockLog.metadata} directly.
   *
    ...
    if (!isProvenanceKey(key)) {
      throw new IllegalArgumentException(
          "ProvenanceSchema.write was given \""
              ...
              + " by name; for anything else call RootstockLog.metadata(key, value) directly.");
    }
    RootstockLog.metadata(key, value == null ? "" : value);
  }
