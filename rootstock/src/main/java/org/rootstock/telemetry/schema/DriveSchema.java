...
/**
 * The section 3.2 key block — {@code Rootstock/Drive/} — as both a published contract and the writer
 * that fills it.
 *
...
public final class DriveSchema {
  ...
  public static final String kPrefix = RootstockLog.kRoot + "/Drive";
  ...
  public static void pose(Pose2d pose) {
    RootstockLog.critical(kPose, pose);
  }
  ...
  public static void pose3d(Pose3d pose) {
    RootstockLog.log(kPose3d, pose, Demotable.YES);
  }
  ...
  public static void odometryOnlyPose(Pose2d pose) {
    RootstockLog.log(kOdometryOnlyPose, pose);
  }
  ...
  public static void visionDivergenceMeters(double meters) {
    RootstockLog.critical(kVisionDivergenceMeters, meters, Units.Meters);
  }
  ...
  public static void measuredSpeeds(ChassisSpeeds speeds) {
    RootstockLog.critical(kChassisSpeedsMeasured, speeds);
  }
  ...
  public static void setpointSpeeds(ChassisSpeeds speeds) {
    RootstockLog.critical(kChassisSpeedsSetpoint, speeds);
  }
  ...
  public static void measuredStates(SwerveModuleState[] states) {
    RootstockLog.critical(kModuleStatesMeasured, states);
  }
  ...
  public static void setpointStates(SwerveModuleState[] states) {
    RootstockLog.critical(kModuleStatesSetpoint, states);
  }
  ...
  public static void optimizedSetpointStates(SwerveModuleState[] states) {
    RootstockLog.log(kModuleStatesSetpointOptimized, states, Demotable.YES);
  }
  ...
  public static void modulePositions(SwerveModulePosition[] positions) {
    RootstockLog.log(kModulePositions, positions, Demotable.YES);
  }
  ...
  public static void gyro(boolean connected, double yawRad, double rawYawRad, double yawRateRadPerSec) {
    RootstockLog.critical(kGyroConnected, connected);
    RootstockLog.critical(kGyroYawRad, yawRad, Units.Radians);
    RootstockLog.critical(kGyroRawYawRad, rawYawRad, Units.Radians);
    RootstockLog.critical(kGyroYawRateRadPerSec, yawRateRadPerSec, Units.RadiansPerSecond);
  }
  ...
  public static void speedMetersPerSec(double metersPerSecond) {
    RootstockLog.log(kSpeedMetersPerSec, metersPerSecond, Units.MetersPerSecond);
  }
  ...
  public static void skidRatio(double ratio) {
    RootstockLog.log(kSkidRatio, ratio);
  }
   ...
   * @return e.g. {@code "Rootstock/Drive/Module0"}
   */
