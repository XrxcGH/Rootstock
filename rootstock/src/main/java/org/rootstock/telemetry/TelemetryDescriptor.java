 ...
 * {@code Rootstock/<Name>/} that was never declared. Without that, a mechanism that silently stops
...
public interface TelemetryDescriptor {
   ...
   * preference. {@code org.rootstock.units.Axis} defines {@code userPerOutputRotation()} as
   ...
   *
   * @param key the key, relative to {@code Rootstock/<Name>/}
   ...
   * {@code Rootstock/Log/SchemaGeneration} like any other.
   *
   * @param key the key, relative to {@code Rootstock/<Name>/}
