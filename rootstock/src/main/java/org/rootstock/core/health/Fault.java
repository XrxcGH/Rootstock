 ...
 * {@code /Rootstock/Health/&lt;Source&gt;/Faults} publishes, what {@code expectNoNewFaults()} in a
 * self-test compares against, and what {@link RobotHealth#active()} lists. Alerts are the
 * <em>driver</em> channel and carry a {@link org.rootstock.core.alert.MatchImpact}, which is a
...
public record Fault(String device, String description, Severity severity, boolean sticky) {
   ...
   * /Rootstock/Health/&lt;Source&gt;/Faults}.
   *
