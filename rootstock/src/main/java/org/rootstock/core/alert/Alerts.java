...
/**
 * THE alert facade. Every alert in every Rootstock domain is created here.
 *
 * <p>One facade, not five: the registry, the {@code /Rootstock/Driver} mirror, the CI alert-budget
 ...
 *
 * <pre>{@code
 * private final RootstockAlert m_disconnected =
...
public final class Alerts {
  ...
  private static RootstockAlert build(
      String group, String text, Severity severity, MatchImpact impact, BooleanSupplier condition) {
