...
import org.rootstock.core.selftest.SelfTestResult.StepResult;
...
final class SelfTestRunner extends Command {
  ...
  private final Set<RootstockAlert> m_blockingAtStart =
  ...
  public void execute() {
    ...
    RootstockAlert culprit = m_routine.abortOnError() ? newBlockingAlert() : null;
    if (culprit != null) {
      m_detail =
  ...
  private RootstockAlert newBlockingAlert() {
    for (RootstockAlert a : AlertRegistry.blocking()) {
