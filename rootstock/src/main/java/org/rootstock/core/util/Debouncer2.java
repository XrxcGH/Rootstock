 ...
 * in each direction — and almost every signal Rootstock debounces is asymmetric: a fault should
 ...
 * {@code Clock.dt()} is not final until {@code RootstockRobot}'s constructor has told it the real loop
