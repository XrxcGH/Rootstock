 ...
 *
 * <p><b>Where this differs from {@code org.rootstock.pure.math.RootstockMath}.</b> {@code RootstockMath}
 ...
 * method exists in both, prefer {@code RootstockMath}: it has nothing to port.
 */
public final class MathX {
   ...
   *
   * <p>For a joystick <i>vector</i>, use {@code RootstockMath.deadband2d} — WPILib has no 2-D
