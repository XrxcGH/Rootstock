...
/**
 * Whether a mechanism's {@link ControlLocation} was chosen by the team or filled in by Rootstock.
 *
...
public enum ControlLocationSource {
  ...
  /** Rootstock filled it in from the leader motor's capabilities. */
  DEFAULTED;

  /**
   * True when Rootstock chose this location rather than the team.
   *
