 ...
 * in Rootstock calls {@link TuningTarget#setVoltage(double)} except this class, and an ArchUnit
 ...
 * </ol>
 *
 * <h2>Why the student always sees "Rootstock stopped this", never a silent device clamp</h2>
 *
...
public final class TuningSupervisor {
  ...
  public void arm() {
    ...
    RootstockLog.log("Tuning/Supervisor/" + who + "/Armed", true);
  }
  ...
  public void abort(AbortReason reason) {
    ...
    resetConditionTimers();
    RootstockLog.log("Tuning/Supervisor/" + m_target.tuningName() + "/Abort", actual.name());
    RootstockLog.log("Tuning/Supervisor/" + m_target.tuningName() + "/AbortMessage", m_lastAbortMessage);
    RootstockLog.log("Tuning/Supervisor/" + m_target.tuningName() + "/Armed", false);
  }
