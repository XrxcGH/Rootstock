...
/**
 * The canonical Rootstock gain set: <b>seven doubles, every one of them volts per SI unit</b>.
 *
 * <pre>
 ...
 * student cannot use. Rootstock canonicalises to volts-per-SI and converts <b>exactly once</b>, in
...
public record Gains(
  ...
  /**
   * The one placeholder value Rootstock ships — a real, named value with defined behaviour, not a
