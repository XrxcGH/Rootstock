...
public final class SimpleMechanism extends Mechanism {
  ...
  private final RootstockAlert m_noHeldSensor;
  ...
  public void set(double dutyCycle) {
    ...
    m_dutyCycle = RootstockMath.clamp(Double.isFinite(dutyCycle) ? dutyCycle : 0.0, -1.0, 1.0);
  ...
  protected void onPeriodic() {
    if (m_heldIo != null) {
      ...
      RootstockLog.processInputs(m_heldInputsKey, m_heldInputs);
    }
