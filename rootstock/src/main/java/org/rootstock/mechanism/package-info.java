 ...
 *
 * <ul>
 *   <li>{@link org.rootstock.mechanism.Mechanism} — the abstract base. It implements {@code
 *       Subsystem}, {@code TelemetrySource}, {@code HealthSource}, {@code SelfTestable} and {@code
 *       TuningTarget}, which is what makes {@code RootstockRegistry.addAll(...)} the only registration
 *       call a team writes.
 *   <li>{@link org.rootstock.mechanism.MechanismMode} — the one state enum, replacing the private
 *       three-boolean state machines every team rewrites.
 *   <li>{@link org.rootstock.mechanism.ManualControl} — deadband, scale, and the
 *       capture-and-hold-on-release edge.
 *   <li>{@link org.rootstock.mechanism.ContinuousUnwrap} — over-360&deg; azimuths and the
 *       field-locked turret.
 *   <li>{@link org.rootstock.mechanism.GoalBus} — the contract that lets auto request mechanism
