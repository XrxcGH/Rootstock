...
public final class RevArchitectureTest {
  ...
  private static final String kAdapterPackage = "org.rootstock.hardware.rev";
  ...
  static final ArchRule theRevAdapterNamesNoCtreType =
      noClasses()
          ...
          .because(
              "dev.rootstock:rootstock-revlib exists so that a REV-only team never installs "
   ...
   * org.rootstock.hardware.rev} and nowhere else.
   *
  ...
  static final ArchRule revIsConfinedToTheAdapterPackage =
      noClasses()
          ...
          .because(
              "every REV type this library touches lives behind a Rootstock interface in "
                  + kAdapterPackage
  ...
  static void theAdapterIsPresentAndReallyUsesRevLib(JavaClasses classes) {
    for (String required :
        List.of(
            ...
            "org.rootstock.hardware.rev.SparkMotorIO",
            "org.rootstock.hardware.rev.RevGainSink")) {
