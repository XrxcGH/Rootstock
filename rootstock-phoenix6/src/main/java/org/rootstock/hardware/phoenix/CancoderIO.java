 ...
 * rotations — the same unit as every other number crossing a Rootstock hardware seam. A CANcoder
 ...
 *
 * <p>Under {@link FeedbackSpec.FusedCancoder} the TalonFX fuses this sensor on-device and Rootstock
...
public final class CancoderIO implements AbsoluteEncoderIO {
  ...
  private RootstockAlert m_magnetAlert;
  ...
  /**
   * The live CANcoder, for the one-in-twenty thing Rootstock does not model.
   *
   * @return the device
   */
  ...
  private RootstockAlert magnetAlert() {
