...
/**
 * The <b>only</b> path by which Rootstock writes a Phoenix 6 configuration, and the reason there
 ...
 *   <li>{@code RootstockRegistry.onDisable()};
 *   <li>self test;
...
public final class PhoenixUtil {
   ...
   */
  private static final Map<String, RootstockAlert> kAlerts = new ConcurrentHashMap<>();
  ...
  private static RootstockAlert alert(String owner, String key, String text, MatchImpact impact) {
