/**
 * The Phoenix 6 adapter — the <b>only</b> package in Rootstock allowed to import {@code com.ctre}.
 *
 * <p>Everything this package exposes to the rest of the library is a Rootstock interface:
 * {@link org.rootstock.hardware.phoenix.TalonFXMotorIO} is a
 * {@link org.rootstock.hardware.MotorIO},
 * {@link org.rootstock.hardware.phoenix.Phoenix6GainSink} is a
 * {@link org.rootstock.control.GainSink},
 * {@link org.rootstock.hardware.phoenix.Pigeon2GyroIO} is a
 * {@link org.rootstock.hardware.GyroIO}. Core never sees a {@code TalonFX} in a signature, and the
