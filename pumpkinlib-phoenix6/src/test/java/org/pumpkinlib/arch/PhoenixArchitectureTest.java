 ...
 *
 * <ul>
 *   <li>{@code com.ctre} appears only inside {@code org.pumpkinlib.hardware.phoenix} — never in a
 ...
 * </ul>
 *
 * <p>Every rule here is scoped to {@code org.pumpkinlib..} so the imported set is the two PumpkinLib
...
public final class PhoenixArchitectureTest {
  ...
  private static final String kAdapterPackage = "org.pumpkinlib.hardware.phoenix";
   ...
   *
   * <p>A Phoenix team's robot must not link REVLib because it depends on PumpkinLib's Phoenix
  ...
  static final ArchRule thePhoenixAdapterNamesNoRevType =
      noClasses()
          ...
          .because(
              "dev.pumpkinlib:pumpkinlib-phoenix6 exists so that a Phoenix team never installs "
   ...
   * org.pumpkinlib.hardware.phoenix} and nowhere else.
   *
   ...
   * org.pumpkinlib.hardware} would be invisible to core's own rule 1 — that jar simply would not
  ...
  static final ArchRule ctreIsConfinedToTheAdapterPackage =
      noClasses()
          ...
          .because(
              "every CTRE type this library touches lives behind a PumpkinLib interface in "
                  + kAdapterPackage
  ...
  static void theAdapterIsPresentAndReallyUsesPhoenix(JavaClasses classes) {
    for (String required :
        List.of(
            ...
            "org.pumpkinlib.hardware.phoenix.TalonFXMotorIO",
            "org.pumpkinlib.hardware.phoenix.Phoenix6GainSink")) {
