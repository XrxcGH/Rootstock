...
/**
 * The <b>one and only</b> place in PumpkinLib that touches a Phoenix {@code Slot0Configs}.
 *
...
public final class Phoenix6GainSink implements GainSink {
  ...
  private PumpkinAlert m_rejectedAlert;
  ...
  private PumpkinAlert rejectedAlert() {
