...
import org.pumpkinlib.config.HardStop;
...
import org.pumpkinlib.config.PositionLimits;
...
import org.pumpkinlib.hardware.SignalSet;
...
abstract class AbstractPhoenixMotorIO implements MotorIO {
  ...
  private PumpkinAlert m_resetAlert;
  private PumpkinAlert m_routingFaultAlert;
  private PumpkinAlert m_dynamicUnavailableAlert;
  ...
  record FollowerDevice(
      CommonTalon talon, ParentDevice device, org.pumpkinlib.config.Follower sense) {}
   ...
   *
   * <p>This is a hardware fact and is <b>not</b> the same question as FOC. PumpkinLib v0.1 only ever
   ...
   * reaching this branch is a PumpkinLib routing bug. Going neutral on a gravity-loaded mechanism
  ...
  private PumpkinAlert resetAlert() {
  ...
  private PumpkinAlert routingFaultAlert() {
      ...
      m_routingFaultAlert =
          Alerts.error(
              ...
              m_name
                  ...
                  + " path. This is a PumpkinLib bug, not your config. The mechanism is being held"
                  ...
                  + " `pumpkin doctor --bundle`.",
              MatchImpact.BLOCKS_MATCH);
    }
    return m_routingFaultAlert;
  }

  private PumpkinAlert dynamicUnavailableAlert() {
