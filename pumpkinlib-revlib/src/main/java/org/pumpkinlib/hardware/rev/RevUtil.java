...
/**
 * The two — and only two — ways PumpkinLib writes configuration to a SPARK.
 *
 ...
 *       wrapped. Nothing in {@code org.pumpkinlib.hardware.rev} lets a REVLib throw escape.
...
public final class RevUtil {
   ...
   * place that turns {@link org.pumpkinlib.config.SparkModel} into REVLib's {@code MotorType}.
   ...
   * PumpkinRegistry.onDisable()}; self-test; homing start and homing completion. It is illegal from
