...
import org.pumpkinlib.config.Follower;
 ...
 *
 * <ol>
 *   <li><b>Import packages.</b> The snippet imports {@code org.pumpkinlib.hardware.ControlLocation}
 *       and {@code org.pumpkinlib.mechanism.HomingStrategy}. Both moved: {@code ControlLocation} is
 *       in {@code org.pumpkinlib.control} and {@code HomingStrategy} is in {@code
 *       org.pumpkinlib.config}. {@code Reduction} is in {@code org.pumpkinlib.pure.units}, not
 *       {@code org.pumpkinlib.units}, which the snippet's wildcard hid.
