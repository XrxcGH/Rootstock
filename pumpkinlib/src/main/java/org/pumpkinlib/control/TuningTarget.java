 ...
 * always volts.
 *
 * <h2>Why this lives in {@code org.pumpkinlib.control} and not in the tuning package</h2>
 *
...
public interface TuningTarget {
   ...
   *
   * <p>Derived, never typed by a team: PumpkinLib's own mechanisms return their geometry's domain.
   *
   ...
   *
   * <p>Derived from the geometry for PumpkinLib's own mechanisms; a hand-rolled target states it.
