...
public enum ControlLocation {
   ...
   *
   * <p>The setpoint <b>latches</b> on the device: PumpkinLib re-sends it on change and on a 10 Hz
   ...
   * on-device loop for a 50 Hz one — and PumpkinLib says so out loud rather than letting it pass.
   */
  RIO_FULL;
   ...
   * student reads when PumpkinLib downgrades or questions their choice.
   *
