 ...
 * always trips first and the student sees "PumpkinLib stopped this" instead of a silent device
 ...
 * unrepresentable across PumpkinLib. Problems are <b>collected</b> by {@link #validate(String)} and
...
public record TravelLimits(double min, double max, double softMargin) {
   ...
   * the guarantee that PumpkinLib stops the mechanism first becomes false while continuing to be
