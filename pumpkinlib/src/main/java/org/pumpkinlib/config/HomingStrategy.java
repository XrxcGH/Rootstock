 ...
 *
 * <p>{@code design/01} §6.3 places this type in {@code org.pumpkinlib.mechanism}. It lives here
...
public sealed interface HomingStrategy
   ...
   *
   * <p>This is the bridge to {@code org.pumpkinlib.control.TuningTarget}, which asks the same
   ...
   * what {@link org.pumpkinlib.units.RotaryAxis} declares users think in.
   *
