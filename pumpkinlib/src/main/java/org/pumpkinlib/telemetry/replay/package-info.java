 ...
 *
 * <p><b>Build time</b> is {@code pumpkinlib-lint}, a javac annotation processor that turns the ten
 ...
 * {@code PumpkinTemplate} gets it and a team that added PumpkinLib as a bare dependency adds one line
 * itself. That is a real hole in the enforcement story and it is not closable from the library side.
 * {@link org.pumpkinlib.telemetry.replay.ReplayExempt} and
 * {@link org.pumpkinlib.telemetry.replay.IoImplementation} are that processor's vocabulary, and they
 * live in the shipped jar so annotating code costs nothing when the processor is absent.
 *
 * <p><b>Runtime</b> is {@link org.pumpkinlib.telemetry.replay.PumpkinReplay}, which every team gets
 ...
 * the fix; {@link org.pumpkinlib.telemetry.replay.PumpkinReplay#assertDeterministic()} is what a test
