 ...
 * were deleted by maintainer decision 3, along with {@code PumpkinInputs}, {@code PumpkinLogTable},
 ...
 * stated in {@link org.pumpkinlib.telemetry.PumpkinLog}'s own javadoc rather than in a footnote.
 *
 ...
 * from here, from {@code org.pumpkinlib.core}, from {@code org.pumpkinlib.tuning} and from
 * {@code org.pumpkinlib.viz}, and nowhere else. Every other package in the library publishes through
 * {@link org.pumpkinlib.telemetry.PumpkinLog}. The point is blast radius: if AdvantageKit does not ship
 ...
 * {@code org.pumpkinlib.core.spi} for {@code LogConfig}, {@code RobotMode} and {@code Tier} — all three
 * live there so that a public core signature naming one is not a rule-9 violation — and telemetry still
 * owns what all three <i>mean</i>. {@link org.pumpkinlib.telemetry.Demotable} stays here, because it is
 ...
 *
 * <ul>
 *   <li>{@link org.pumpkinlib.telemetry.PumpkinLog} — the static facade. {@code critical}, {@code log},
 *       {@code debug}, {@code processInputs}, {@code timestamp}, {@code isReplay}. No {@code put}.
 *   <li>{@link org.pumpkinlib.telemetry.TelemetrySource} — implemented by every mechanism, drivetrain
 *       and camera. Registration and declaration only; values are pushed, never pulled.
 *   <li>{@link org.pumpkinlib.telemetry.Demotable} — the opt-in marking that lets the governor sample a
