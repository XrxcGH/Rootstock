...
/**
 * Marks a hand-written {@code LoggableInputs} struct as a PumpkinLib IO inputs class.
 *
 ...
 * came with a {@code PumpkinInputs} interface and a {@code LogSink}/{@code LogSource} pair. Decision 3
 ...
 * Every {@code *Inputs} class in PumpkinLib now implements
 ...
 * {@link PumpkinLog#processInputs}</i>. Two consumers care:
 *
 * <ul>
 *   <li>{@code pumpkinlib-lint} uses it to locate inputs structs when enforcing the input invariant —
