/**
 * The automatic telemetry schema: the key layout every PumpkinLib mechanism, drivetrain and vision
 * source publishes, the writers that fill it, and the emitter that makes it diffable between
 * releases.
 *
 * <h2>The promise</h2>
 *
 * <p>Every PumpkinLib mechanism, drivetrain and vision source logs a consistent schema with
 ...
 *
 * <ul>
 *   <li>{@link org.pumpkinlib.telemetry.schema.MechanismSchema} — section 3.1,
 *       {@code Pumpkin/<Name>/}. The flagship. Also the writer for a swerve module's nested block.
 *   <li>{@link org.pumpkinlib.telemetry.schema.DriveSchema} — section 3.2, {@code Pumpkin/Drive/}.
 *   <li>{@link org.pumpkinlib.telemetry.schema.VisionSchema} — section 3.3,
 *       {@code Pumpkin/Vision/<Camera>/} and its roll-ups.
 *   <li>{@link org.pumpkinlib.telemetry.schema.FieldSchema} — section 3.4, {@code Pumpkin/Field/},
 *       the ghost contract.
 *   <li>{@link org.pumpkinlib.telemetry.schema.HealthSchema} — section 3.5, {@code Pumpkin/Health/}.
 *   <li>{@link org.pumpkinlib.telemetry.schema.ProvenanceSchema} — section 3.6, the twelve
 *       write-once metadata fields.
 *   <li>{@link org.pumpkinlib.telemetry.schema.SchemaGeneration} — the emitter and its fingerprint.
 * </ul>
 *
 ...
 *       {@link org.pumpkinlib.telemetry.schema.MechanismSchema#publish()} from goal, setpoint and
 ...
 *
 * <p>{@code org.pumpkinlib.mechanism}, {@code org.pumpkinlib.drive} and {@code org.pumpkinlib.vision}
