 ...
 * {@link PumpkinAlert} does the edge detection and the per-alert rate limit; this class does the
...
public final class AlertBridge {
  ...
  public interface NotificationSink {
     ...
     * per {@link PumpkinAlert#kMinNotifyCycles} cycles per alert.
     *
  ...
  /**
   * Arm the bridge. Called by {@link AlertRegistry#bridgeToDashboard()}, which {@code PumpkinRobot}
  ...
  /**
   * Deliver one rising edge. Called only by {@link PumpkinAlert}, which has already checked that
   ...
   */
  static void onRisingEdge(PumpkinAlert alert) {
