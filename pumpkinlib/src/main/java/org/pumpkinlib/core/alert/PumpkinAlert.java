 ...
 *
 * <p><strong>One fault type, not two.</strong> The old {@code PumpkinFaults} concept is folded in
...
public final class PumpkinAlert implements AutoCloseable {
   ...
   */
  public PumpkinAlert demoteExpectedAbsent(String reason) {
   ...
   *
   * <p>This is where design doc 04's {@code PumpkinFaults} lives — a sticky fault is
   * {@code PumpkinAlert.sticky(true)}, so there is one fault type in the library and not two. A
   ...
   * @return this, for chaining
   */
  public PumpkinAlert sticky(boolean sticky) {
    m_sticky = sticky;
    return this;
  }
   ...
   * here — because the loop period is not final until {@code PumpkinRobot}'s constructor has run,
