 ...
 *
 * <p><b>Teams extend this set by adding constants to their own enum.</b> Nothing in PumpkinLib
 * hardcodes the members of this enum by name except {@link #SIM}, which the simulation strategy
 * and the {@code pumpkinCheckDeploy} build gate both reason about explicitly. If your team has two
...
public enum RobotId {
   ...
   *
   * <p>{@code pumpkinCheckDeploy} hard-fails a deploy whose declared fallback is this value, with
