 ...
 *
 * <p>You do not register this yourself. {@code PumpkinRegistry.addAll(m_drive, m_elevator, m_arm)}
...
public interface HealthSource {
   ...
   * /Pumpkin/Health/&lt;name&gt;/}), the {@link org.pumpkinlib.core.alert.Alerts} group for mirrored
