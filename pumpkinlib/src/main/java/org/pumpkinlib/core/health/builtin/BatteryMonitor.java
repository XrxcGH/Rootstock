...
public final class BatteryMonitor implements HealthSource {
  ...
  private PumpkinAlert m_restingAlert;
  private PumpkinAlert m_sagAlert;
   ...
   * PumpkinAlert#debounce(Time)}, so a replayed log debounces on exactly the cycles the real robot
   * did.
   *
   * @param t default 2 s
   * @return this, for chaining
