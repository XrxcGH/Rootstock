 ...
 * ({@code org.pumpkinlib.core.compat}) — <b>not</b> {@code RobotBase} directly, because ArchUnit
 ...
 *
 * <p><b>Why this enum is in {@code core.spi} rather than {@code org.pumpkinlib.telemetry}.</b>
