 ...
 *
 * <p>Two PumpkinLib buttons mutate persistent robot state: {@code RobotIdentity.assignCommand(id)}
 ...
 * library — {@code org.pumpkinlib.core.match.MatchContext} — and that rule is absolute, because it
