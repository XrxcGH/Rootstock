 ...
 * {@link PumpkinRegistry#addAll(Object...)} collects every fault from every registered component,
 ...
 *
 * <ul>
 *   <li>completes {@link PumpkinLifecycle#init()} and <b>boots</b>; the driver station connects and
 ...
 *   <li>publishes {@code /Pumpkin/Driver/SafeMode = true} and {@code /Pumpkin/Driver/SafeModeErrors}
 *       with the full list;
 *   <li>raises one persistent {@link org.pumpkinlib.core.alert.Severity#ERROR} alert naming the
 *       count and the first fault verbatim.
 * </ul>
 *
 * <p>The difference is a five-minute fix in the pits instead of a lost match.
 *
 * <p><b>Why the fault type lives here rather than in {@code org.pumpkinlib.config}.</b> {@code
 * org.pumpkinlib.config.ConfigError} is the config domain's declaration of the same six fields and
 ...
 * {@link PumpkinRegistry#addFaultExtractor} is the seam the config domain plugs its {@code
...
public final class SafeMode {
   ...
   *
   * <p>The field set mirrors {@code org.pumpkinlib.config.ConfigError} exactly (design/01 §5.6) so
  ...
  public record Fault(
    ...
    /**
     * One line, for the alert panel and for the {@code /Pumpkin/Driver/SafeModeErrors} array.
     *
    ...
    public String describe() {
      ...
      sb.append("PumpkinLib config error [").append(level).append("] in \"").append(owner)
  ...
  public static final String kSafeModeKey = "/Pumpkin/Driver/SafeMode";

  /** The NetworkTables/log key carrying the full rendered fault list. */
  public static final String kSafeModeErrorsKey = "/Pumpkin/Driver/SafeModeErrors";
  ...
  private static PumpkinAlert s_alert;
   ...
   * {@link PumpkinRegistry#addAll(Object...)}; a team wiring validation by hand may call it too.
   *
   ...
   * {@link PumpkinLifecycle#init()} and {@link PumpkinLifecycle#disabledInit()} do, which is every
   * moment the value can have changed. It is a plain log output rather than a {@code PumpkinLog}
  ...
  /**
   * The whole state, printed at boot and by {@code pumpkin doctor}.
   *
