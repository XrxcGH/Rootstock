 ...
 * periodic rate is expressed in PumpkinLib. A wall-clock gate — {@code if (now - m_last > 0.25)} —
 ...
 * three, costs one modulo, and makes {@code PumpkinReplayVerify} diffs meaningful instead of noisy.
 *
...
public final class Rate {
   ...
   * construction, because {@code Clock.dt()} is not final until {@code PumpkinRobot}'s constructor has
