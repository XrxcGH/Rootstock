 ...
 * wire. That is what lets Elastic bind a Text Display to {@code /PumpkinTuner/state} with no setup
 * and lets AdvantageScope graph {@code /PumpkinTuner/plot/volts} with no setup, and it is what makes
...
public final class TunerPublisher {
  ...
  public static final String kRoot = "/PumpkinTuner";
   ...
   * constructor, immediately after {@code PumpkinRegistry.addAll(...)}.
   */
  ...
  public static String metaJson(String mechanism) {
    ...
    field(sb, "libraryVersion", PumpkinLib.VERSION).append(',');
