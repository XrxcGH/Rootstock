 ...
 * is {@link Quality#UNUSABLE} is one PumpkinLib refuses to accept, and it says why rather than
...
public record FeedforwardFit(
  ...
  public enum Quality {
    ...
    SUSPECT,
    /** Not trustworthy. PumpkinLib will not accept it. */
    UNUSABLE;
    ...
    public String explain() {
      return switch (this) {
        ...
        case UNUSABLE ->
            "This fit is not trustworthy and PumpkinLib will not accept it. Run the mechanical "
  ...
  /**
   * Whether PumpkinLib will let this fit be accepted.
   *
