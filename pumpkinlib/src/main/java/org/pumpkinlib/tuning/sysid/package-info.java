 ...
 * never repeats it. {@link org.pumpkinlib.tuning.sysid.FeedforwardRegression} does the same fit on
 ...
 * that limits are the team's problem. That is the gap {@link org.pumpkinlib.control.TuningSupervisor}
 * fills, and {@link org.pumpkinlib.tuning.sysid.SysIdSweep} is what wires the two together: the ramp
