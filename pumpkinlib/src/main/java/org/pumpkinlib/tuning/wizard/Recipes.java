...
import org.pumpkinlib.tuning.wizard.steps.LqrSuggestStep;
...
import org.pumpkinlib.tuning.wizard.steps.SysIdSweepStep;
...
public final class Recipes {
  ...
  public static TuningRecipe forArchetype(MechanismArchetype archetype, TuningRecipe.Mode mode) {
    ...
    throw new IllegalArgumentException(
        "PumpkinLib does not ship a tuning recipe for "
            + archetype
