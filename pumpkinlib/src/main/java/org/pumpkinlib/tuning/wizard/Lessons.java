...
public final class Lessons {
  ...
  public static final String KS =
      ...
      In this step, PumpkinLib will slowly increase the voltage from zero until it sees the \
  ...
  public static final String KV =
      ...
      In this step, PumpkinLib will ramp the voltage up very slowly and watch how fast the \
  ...
  public static final String KA =
      ...
      PumpkinLib has worked out a step size that uses less than half your remaining travel and \
  ...
  public static final String KG =
      ...
      why PumpkinLib does not ask you to guess and redeploy. This step first lets go for half a \
      ...
      when released, PumpkinLib finds which way gravity pulls another way: it measures how hard \
  ...
  public static final String P =
      ...
      PumpkinLib does not ask you to guess kP. It already measured kV and kA, which together \
  ...
  public static final String WHAT_THE_SLIDERS_DO =
      ...
      PumpkinLib is not guessing your kP. It already measured how your mechanism responds to \
  ...
  public static final String D =
      ...
      If PumpkinLib tells you it is halving kD because it saw a 14 Hz buzz, that is what \
      happened.""";
  ...
  public static final String I =
      ...
      PumpkinLib will let you use I. It just will not let you use it carelessly: you have to \
      supply an I-zone (the error band outside which the integrator is switched off) and a voltage \
      cap, in the same breath as kI.

      Before you reach for I, look at the number PumpkinLib shows you called "residual volts." \
  ...
  public static final String MOTION_PROFILES =
      ...
      You do not have to guess the speed limit. PumpkinLib works out the fastest speed your \
      ...
      rigging should be asked to. PumpkinLib will tell you what the motor could do, and how many \
  ...
  public static final String WHY_FEEDFORWARD_FIRST =
      ...
      cannot see friction break loose while the mechanism is falling. So PumpkinLib does a quick \
  ...
  public static final String WHY_UNITS_MATTER =
      ...
      PumpkinLib and WPILib measure error in metres or radians, and output in volts. A Kraken \
      ...
      PumpkinLib fixes this by having exactly one unit system - volts per SI unit - and converting \
      ...
      You can see the exact conversion PumpkinLib is doing for your mechanism in the "Conversion" \
