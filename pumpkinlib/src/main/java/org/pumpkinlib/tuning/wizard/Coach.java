...
public final class Coach {
  ...
  public static String recommendation(ResponseVerdict verdict) {
    ...
    switch (verdict.classification()) {
      ...
      case SLUGGISH:
        return "Turn kP up. PumpkinLib will multiply it by 1.6 and try again - press A, or press B "
            + "to change it yourself.";
      case OVERSHOOT_RING:
        return "Add damping: cut kP by 30%, or add kD. PumpkinLib will try kD first, because that "
