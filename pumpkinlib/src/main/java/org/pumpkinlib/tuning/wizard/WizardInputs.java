...
public interface WizardInputs {
  ...
  /**
   * The student's answer to a {@link org.pumpkinlib.tuning.wizard.steps.PredictStep}, as an option
   * index of 0, 1 or 2.
   *
   * <p>Empty means "no answer offered this loop", which is the normal case: the wizard also accepts
   * an answer written to {@code /PumpkinTuner/predict/answer} by a dashboard combo box, so a
