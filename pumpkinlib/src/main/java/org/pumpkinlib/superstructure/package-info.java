 ...
 * group. {@link org.pumpkinlib.superstructure.Superstructure} is <i>itself</i> the one
 ...
 * {@linkplain org.pumpkinlib.superstructure.Superstructure default-output inversion} applies every
 ...
 * {@link org.pumpkinlib.superstructure.SafetyModel} replaces a ~250-line hand-written branch tree
 ...
 * {@link org.pumpkinlib.superstructure.AxisGoal.Named} setpoint strings are resolved at
 ...
 *
 * <ul>
 *   <li>{@link org.pumpkinlib.superstructure.SuperState} — the interface a team's state enum
 *       implements. The enum is the team's; the machinery is ours.
 *   <li>{@link org.pumpkinlib.superstructure.AxisGoal} — what one axis is being told to do, as a
 *       sealed value type.
 *   <li>{@link org.pumpkinlib.superstructure.GoalReceiver} — the seam between a goal and the
 *       mechanism that honours it.
 *   <li>{@link org.pumpkinlib.superstructure.Interlock} — a declarative, inspectable rule about
 *       which transitions are permitted.
 *   <li>{@link org.pumpkinlib.superstructure.SafetyModel} — declarative forbidden zones and
 *       corridors over a two-axis configuration space.
 *   <li>{@link org.pumpkinlib.superstructure.TransitionPlanner} — plans from live measured state,
 *       and gates every waypoint on measurement rather than on a timer.
 *   <li>{@link org.pumpkinlib.superstructure.SuperstructureReport} — the static analysis computed at
 *       construction, printed in the boot dump.
 *   <li>{@link org.pumpkinlib.superstructure.Superstructure} — the state machine itself, which is
 ...
 * not. {@link org.pumpkinlib.superstructure.SafetyModel.Router} is the seam it lands behind. Until
 * one is installed, a move whose bounding box crosses a zone is refused, loudly, with the zone
 * named — and {@link org.pumpkinlib.superstructure.SuperstructureReport#transitionsCrossingAZone()}
